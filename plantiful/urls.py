...
urlpatterns = [
    ...
    path("container/<int:container_id>/relocation", views.container_relocation, name="container_relocation"),
    path("container/<int:container_id>/relocation/new", views.new_relocation, name="new_relocation"),
    path("container/<int:container_id>/resoil", views.container_resoil, name="container_resoil"),
    path("container/<int:container_id>/resoil/new", views.new_resoil, name="new_resoil"),
    path("container/<int:container_id>/transplant", views.container_transplant, name="container_transplant"),
    ...
    path("plant/<int:plant_id>/observation", views.plant_observation, name="plant_observation"),
    path("plant/<int:plant_id>/observation/new", views.new_observation, name="new_observation"),
    ...
    path("plant/<int:plant_id>/relocation", views.plant_relocation, name="plant_relocation"),
    path("plant/<int:plant_id>/resoil", views.plant_resoil, name="plant_resoil"),
    path("plant/<int:plant_id>/transplant", views.plant_transplant, name="plant_transplant"),
    path("plant/<int:plant_id>/transplant/new", views.new_transplant, name="new_transplant"),
